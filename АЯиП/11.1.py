"""
Работа №11.1 - Общий вариант - Кортежи
...
- Переменные:
	- numsCount - кол-во чисел в наборе;
	- nums - сам набор;
	- targetNum - искомое произведение;
	- targetNumFlag - логическое значение найдена ли пара из набора произведение которой равно targetNum;
	- i, j - параметры цикла.
"""
